...
The interpretation of this theorem would be the first term in $O_{.}$ is variance term, 

the second term $H^{\rho+1}$ is approximated power for univariate spline bias term, 

and the third term is approximated power for bivariate spline bias term, 

and last term is a penalty term. 
